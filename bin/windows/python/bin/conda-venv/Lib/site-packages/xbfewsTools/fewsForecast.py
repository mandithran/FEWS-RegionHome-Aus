...
class fewsForecast:
    ...
    def load_hotspots(self):
        """
        Loads hotspots (in MapLayerFiles) into dataframe.
        """
...
# TODO: hotspot forecast
# Untilizes composition rather than class inheritance.
# hotspotForecast class not dependent on fewsForecast class
# But it contains an instance of the fewsForecast class so that it can grab all of its properties and methods
class hotspotForecast:
    ...
    def __init__(self,fewsForecast, siteName):
        ...
        # Forecast horizon
        self.forecastHorizon = timedelta(days=int(3)) # in days, datetime object
    ...
    def init_hotspotInfo(self):
        ...
        self.xbeachEPSG = self.hotspotInfo["xbeach_EPSG"][0]
