...
gaugesDir = os.path.join(xbWorkDir,"postProcess\\gauges")
visualizeDir = os.path.join(xbWorkDir,"postProcess\\visualize")
...
################ plotmymap function ################
def plotmymap(axs, gaugefile=None, imagery=None, time=None, epsg=None):
    ...
    gdf.plot(ax = axs, markersize = 20, color="blue", marker="o")
    print(gdf.head())
...
for file in os.listdir(gaugesDir):
    if file.endswith(".shp"):
        ...
        ########### Plot map ###########
        plotmymap(ax, gaugefile=os.path.join(gaugesDir,file), 
                 imagery=imagery, time=time_s, epsg=epsg)
