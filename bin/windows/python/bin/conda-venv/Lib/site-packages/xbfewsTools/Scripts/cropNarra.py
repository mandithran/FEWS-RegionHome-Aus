...
xbf = os.path.join(workDir,"ncfiles","xbNarra_zb.nc")
...
# Export file to nc
xbds.to_netcdf(os.path.join(workDir, "ncFiles","xbNarra_zb_2021.nc"))
...
df.to_csv(os.path.join(workDir, "ncFiles", "xBeachGrid_2021.csv"), index=False)