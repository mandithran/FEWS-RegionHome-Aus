...
leadtimes = [6,12,24,48,72] # in hours
# Tide predictions In GMT
ifile = "C:\\Users\\z3531278\\Documents\\01_FEWS-RegionHome-Aus\\Data\\Tides\\processed\\SydneyTidesGMT.csv"
...
df.to_csv(os.path.join(oDir,"WL-NTR-obs_%s_NoNTS.csv" % siteName))
...
# Paths
wlDir = "J:\\Coastal\\Data\\Tide\\WL Forecast\\BOM Storm Surge\\raw"
...
for fi in df_files['fileName']:
    try:
        ...
        for leadTime in leadtimes:
            ...
            # ASSUME TWL IS ASTRONOMICAL TIDE ONLY
            df_nss["twl_for"] = df_nss["tide"]
