...
set systemStartDate=2020-02-01 
rem Format: HH:MM
...
"C:\Users\z3531278\Documents\01_FEWS-RegionHome-Aus\bin\windows\python\bin\conda-venv\python.exe" "C:\Users\z3531278\Documents\01_FEWS-RegionHome-Aus\Scripts\runForecast\run_forecast_loop_debug.py" %regionHome% %systemStartDate% %systemStartTime% %systemEndDate% %systemEndTime%
pause